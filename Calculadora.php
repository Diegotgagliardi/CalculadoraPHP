...
class Calculadora {
    public function calcular($numero1, $numero2, $operacao) {
        switch ($operacao) {
            case '+':
...
if (isset($_POST['calcular'])) {
    ...
    $_SESSION['historicotext'] = "$numero1 $operacao $numero2 = $resultado";
}
...
<div class="container text-center">
    ...
    <form method="post" class="mb-3">
        <div class="row justify-content-center">
            <div class="col-md-3">
                <input type="text" name="numero1" class="form-control" value="<?php echo $numero1; ?>" placeholder="Número 1">
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-3">
                <input type="text" name="numero2" class="form-control" value="<?php echo $numero2; ?>" placeholder="Número 2">
            </div>
            <div class="col-md-2">
